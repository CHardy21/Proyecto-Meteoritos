...
onready var icono_base:Sprite = $CuadroMiniMapa/ContenedorIconos/ZonaRenderMiniMapa/IconoBaseEnemy
onready var icono_estacion:Sprite = $CuadroMiniMapa/ContenedorIconos/ZonaRenderMiniMapa/IconoEstacionRecarga
